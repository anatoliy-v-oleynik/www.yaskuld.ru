...
$icq = new mlCQ();   
$icq->start_logging('../icq.log');   
    
$icq->create_identity("me", '487909485', '104622');   
$icq->connect();   
$icq->login();   
    
$icq->set_status('ONLINE', 'DCDISABLED');   
$icq->request_offline_messages();   
$icq->delete_offline_messages();   
    
$icq->send_message(286185111, $msg);   
$icq->close();
